...
<div></div>
 <div>
  <button class="btn btn btn-primary btn-sm"  onclick="generarreportemadpedido();"  id="busqueda" name="busqueda"> <i class="far fa-file-excel" aria-hidden="true"></i> Generar reporte</button>
</div>
