...
<input type="input" id="nom_doc_prov" name="nom_doc_prov" > 
<input type="button"  class="btn btn btn-primary btn-sm"  id="busquedaproveedor" name="busquedaproveedor" value="busqueda"> 
<br>
<br>
<br>   
...
<script type="text/javascript">
   var nom_prov_motorizado_b='<?php echo trim($this->session->userdata('identity'));?>';   
