...
<?php endif;?>
 ...
 <input class="btn btn btn-danger btn-sm" type="button"  id="cambiar_estado1" name="cambiar_estado1"  value="Cambiar a estado 1" > 
 <input class="btn btn-success" type="button"  id="modi_fecha" name="modi_fecha"  onclick ="modificar_fecha()" value="modificar fechas" > 
