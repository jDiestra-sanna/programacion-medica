...
*/
$config['tables']['users']           = 'm_usuarios';
$config['tables']['groups']          = 'm_permiso';
$config['tables']['users_groups']    = 'm_permisoxusuario';
 ...
 */
$config['join']['users']  = 'nom_usu';
$config['join']['groups'] = 'cod_permiso';
...
$config['admin_group']                = 'PROGffRAMACION MEDICA - SUPERVISOR';             // Default administrators group, use name
$config['identity']                   = 'nom_usu';             /* You can use any unique column in your table as identity column.
