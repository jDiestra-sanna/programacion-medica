...
>>>>>>> b2f70472ecb97bbf9ecdc7f205ea10c8e5e7b929
        ...
        * */
        ...
        var afterSelecting = function(ev,targetArea){
            ...
            else if(key[0]===3 || key[0]===2 ){ targetState = 0;}   //鼠标右键,将选定区域置0

            if(isSelecting && curDom.hasClass("TimeSheet-cell") && !curDom.hasClass("TimeSheet-cell-selected") || isColSelecting && curDom.hasClass("TimeSheet-colHead")){
            ...
            } else if(curDom.hasClass("TimeSheet-cell-selected") ){
                  if(key[0]===1){       targetState = 0;}   //鼠标左键,将选定区域置1
            else if(key[0]===3 || key[0]===2 ){ targetState = 0;}   //鼠标右键,将选定区域置0
                sheetModel.set(targetState,{
                    startCell : targetArea.topLeft,
                    endCell   : targetArea.bottomRight
